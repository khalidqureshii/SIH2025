...
//     };
//   }[];
//   advisory_from_ai: { date: string; advice: string }[];
// }
...
//           // remove hour arrays if present (same transform as before)
...
//       {/* Parent grid with 3 rows (1 column) */}
//       <div className="grid grid-rows-[auto_auto_auto] gap-4 w-full">

//         {/* ROW 1: FORM (kept exactly as before) */}
...
//         <div className="p-2 bg-transparent rounded shadow flex justify-center items-center">
//           <WeatherCarousel loading={loading} error={error} data={data} />
//         </div>

//         <div className="p-2 bg-transparent rounded shadow flex justify-center">
//           {/* <div className="w-full max-w-3xl">
//             <Graphs data={data} loading={loading} error={error} height={220} className="p-2" />
//           </div> */}
//         </div>
//       </div>
//     </div>

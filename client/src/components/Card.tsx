...
const Card: React.FC<CardInterface> = (props) => {
    ...
    if (loading) return <Loader src="https://lottie.host/f2784c2b-d89d-4b1d-9176-2c3c43a1f57e/eI03PSK8Bi.lottie" 
    ...
    const localTime = new Date(locationData.localtime).toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' });

    return (
        <div className="max-w-sm mx-auto bg-gradient-to-br from-cyan-900 to-blue-400 text-white rounded-2xl shadow-lg p-6">
            <div className="flex justify-between items-start mb-4">
                ...
                <div className="flex flex-col items-center">
                    <img 
                        ...
                        className="w-24 h-24"
                    />
                    <p className="text-center font-semibold text-sm">{dayData.condition.text}</p>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 gap-x-8 gap-y-4 text-sm">
                ...
                <div className="flex flex-col items-center">
                    ...
                    <span className="font-bold text-lg">{dayData.maxwind_kph} km/h</span>
                </div>
                <div className="flex flex-col items-center">    

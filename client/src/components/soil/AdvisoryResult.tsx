...
import "./advisoryResultNoScrollbar.css";
...
export function AdvisoryResult({ result }: AdvisoryResultProps) {
  ...
  // nutrientData needs to be defined even if result is undefined, but only used if result exists
  const nutrientData = result
    ? [
        {
          name: t("advisory_result.nutrients.labels.nitrogen"),
          value: result.nutrients.n,
        },
        {
          name: t("advisory_result.nutrients.labels.phosphorus"),
          value: result.nutrients.p,
        },
        {
          name: t("advisory_result.nutrients.labels.potassium"),
          value: result.nutrients.k,
        },
      ]
    : [];
  ...
  return (
    <div className="mt-6 w-full max-w-3xl p-4 rounded-lg shadow bg-gray-50 bg-white/60">
      <h2 className="text-2xl font-semibold text-center mb-4">
        {t("advisory_result.report_title")}
      </h2>

      <Tabs defaultValue="weather" className="w-full">
        <div className="overflow-x-auto no-scrollbar">
          <TabsList
            className="flex gap-1 px-2 py-1 min-w-max"
          ...
          >
            ...
            >
              {t("advisory_result.tabs.weather")}
            </TabsTrigger>
            <TabsTrigger
              value="satellite"
              className="relative text-sm px-4 py-2 text-gray-600 
             ...
             after:transition-transform after:duration-300"
            >
              {t("advisory_result.tabs.satellite")}
            </TabsTrigger>
            <TabsTrigger
              value="nutrients"
              className="relative text-sm px-4 py-2 text-gray-600 
             ...
             after:transition-transform after:duration-300"
            >
              {t("advisory_result.tabs.nutrients")}
            </TabsTrigger>
            <TabsTrigger
             ...
             after:transition-transform after:duration-300"
            >
              {t("advisory_result.tabs.recommendations")}
            </TabsTrigger>
            <TabsTrigger
              value="ai_insights"
              className="relative text-sm px-4 py-2 text-gray-600 
                ...
                after:transition-transform after:duration-300 "
            >
              {t("advisory_result.tabs.ai_insights")}
            </TabsTrigger>
            {result.fertilizer_guidance &&
              result.fertilizer_guidance.length > 0 && (
                <TabsTrigger
                  value="fertilizer_guidance"
                  className="relative text-sm px-4 py-2 text-gray-600 
                  data-[state=active]:bg-transparent 
                  data-[state=active]:shadow-none 
                  data-[state=active]:ring-0 
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.weather.temperature.button")}
                </Button>
              </HoverCardTrigger>
                ...
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.weather.temperature.title")}
                    </h4>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.weather.humidity.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.weather.humidity.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.weather.rainfall.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.weather.rainfall.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
            ...
            <p className="text-2xl font-bold text-green-700 mt-2">
              {result.weather.rainfall.toFixed(2)}{" "}
              {t("advisory_result.weather.rainfall.unit")}
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.weather.season.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.weather.season.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
        ...
        >
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.satellite.ndvi.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.satellite.ndvi.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.satellite.ndwi.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.satellite.ndwi.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.satellite.soil_moisture.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.satellite.soil_moisture.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
          ...
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            ...
            <HoverCard>
              <HoverCardTrigger asChild>
                <Button variant="link">
                  {t("advisory_result.satellite.soil_ph.button")}
                </Button>
              </HoverCardTrigger>
              <HoverCardContent className="w-60 bg-gray-100 shadow-lg rounded-xl">
                <div className="flex justify-between gap-4">
                  <div className="space-y-1">
                    <h4 className="text-sm font-semibold">
                      {t("advisory_result.satellite.soil_ph.title")}
                    </h4>
                    <p className="text-sm text-gray-600">
        ...
        >
          ...
          <div className="w-full max-w-3xl">
            <h3 className="text-lg font-semibold text-gray-700 mb-3 text-center">
              {t("advisory_result.recommendations.title")}
            </h3>
            <div className="flex flex-wrap justify-center gap-3">
              {Object.entries(result.recommendations.crops).map(
                ([cropName, cropData]) => (
                  <div key={cropName} className="flex flex-col items-center">
                    <button
                      onClick={() =>
                        setOpenCrop(openCrop === cropName ? null : cropName)
                      }
                    ...
                    {openCrop === cropName && (
                      <div className="mt-4 w-full rounded-2xl shadow-lg border border-green-100 overflow-hidden bg-white transform transition-all duration-300 hover:scale-[1.02]">
                        <div className="bg-gradient-to-r from-green-400 to-green-600 px-4 py-2 text-center">
                          <p className="font-bold text-white text-lg">
                            {cropName}
                          </p>
                          <p className="text-xs text-green-50 opacity-80">
                            {t("advisory_result.recommendations.crop_insights")}
                          </p>
                        </div>
                        <div className="p-5 space-y-2 text-gray-700 text-sm">
                          <p>
                            <span className="font-medium text-gray-600">
                              {t(
                                "advisory_result.recommendations.fields.confidence"
                              )}
                            </span>{" "}
                          ...
                          <p>
                            <span className="font-medium text-gray-600">
                              {t(
                                "advisory_result.recommendations.fields.expected_yield"
                              )}
                            </span>{" "}
                            <span className="font-semibold text-green-700">
                              {cropData["Expected Yield"]}
                            </span>
                          </p>
                          <p>
                            <span className="font-medium text-gray-600">
                              {t(
                                "advisory_result.recommendations.fields.suitability"
                              )}
                            </span>{" "}
                            <span className="font-semibold text-green-700">
                              {cropData.Suitability}
                            </span>
                          </p>
                          <p>
                            <span className="font-medium text-gray-600">
                              {t(
                                "advisory_result.recommendations.fields.seasonal_match"
                              )}
                            </span>{" "}
                            <span className="font-semibold text-green-700">
                              {cropData["Seasonal Match"]}
                            </span>
                          </p>
                          <p>
                            <span className="font-medium text-gray-600">
                              {t(
                                "advisory_result.recommendations.fields.overall_score"
                              )}
                            </span>{" "}
                            <span className="font-semibold text-green-700">
                              {cropData["Overall Score"]}
                            </span>
                          </p>
                        </div>
                      </div>
        ...
        >
          ...
          <div className="max-w-3xl bg-white rounded-2xl shadow-lg border border-green-200 overflow-hidden">
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3">
              <h3 className="text-lg font-semibold text-white">
                {t("advisory_result.ai_insights.diagnostics")}
              </h3>
            </div>
        ...
        {result.fertilizer_guidance &&
          result.fertilizer_guidance.length > 0 && (
            ...
            >
              ...
              <div className="max-w-3xl bg-white rounded-2xl shadow-lg border border-green-200 overflow-hidden w-full">
                <div className="bg-gradient-to-r from-green-500 to-emerald-600 px-6 py-3">
                  <h3 className="text-lg font-semibold text-white">
                    Recommended Fertilizer Steps
                  </h3>
                </div>
                <ul className="p-6 space-y-3 text-gray-700 list-disc list-inside">
                  {result.fertilizer_guidance.map((item, idx) => (
                    <li key={idx}>{item}</li>
                  ))}
                </ul>
              </div>

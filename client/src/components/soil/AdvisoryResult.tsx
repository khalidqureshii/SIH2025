  ...
  return (
    <div className="mt-6 w-full max-w-3xl p-4 rounded-lg shadow bg-gray-50 bg-white/60">
      ...
      <Tabs defaultValue="weather" className="w-full">
        ...
        <TabsList className="flex space-x-1 w-max px-2 py-1">
          <TabsTrigger value="weather"
          className="relative text-sm px-4 py-2 text-gray-600 
             data-[state=active]:bg-transparent 
             data-[state=active]:shadow-none 
       ...
       <TabsContent value="weather" className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl mx-auto">
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            {/* <p className="text-sm font-medium text-gray-500">Temperature🌡️</p> */}
            <HoverCard>
              <HoverCardTrigger asChild>
        ...
        <TabsContent value="satellite" className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full max-w-4xl mx-auto">
          <div className="bg-white p-6 rounded-xl shadow-md text-center border border-gray-100 hover:shadow-lg transition">
            {/* <p className="text-sm font-medium text-gray-500">NDVI (Vegetation Health)</p> */}
             <HoverCard>
              <HoverCardTrigger asChild>

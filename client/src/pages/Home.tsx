  ...
  return (
    <div className="min-h-screen relative flex flex-col items-center p-6 overflow-hidden">
      <div className="relative z-10 flex flex-col items-center w-full mt-8">
        ...
        <p className="text-gray-700 text-xl font-semibold mb-6 mt-2 text-center">
          {t("home.subheader")}
        </p>
        ...
        >
          ...
          <div
            onClick={() => navigate("/crop-identification-disease-detection")}
            className="rounded-xl shadow-lg bg-white/70 backdrop-blur-md 
               flex flex-col overflow-hidden hover:shadow-2xl hover:scale-[1.02] 
               transition cursor-pointer"
          >
            ...
            <div className="flex flex-col flex-1 px-4 py-4">
              <h3 className="text-lg font-bold text-[rgb(184,20,20)] mb-2">
                {t("home.shortcut_labels.crop_and_disease")}
              </h3>
              <p className="text-sm text-gray-600">
                {t("home.descriptions.crop_and_disease") ||
